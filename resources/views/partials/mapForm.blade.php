        ...
        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="artist">artist</label>
            <input type="text" name="artist" max="40" value="{{ old('artist', $map->artist ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
                <label class="button p-10 bold flex flex-f-center" for="title">title</label>
                <input type="text" name="title" max="80" value="{{ old('title', $map->title ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="artistUnicode">artist (unicode)</label>
            <input type="text" name="artistUnicode" max="25" value="{{ old('artistUnicode', $map->artistUnicode ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="titleUnicode">title (unicode)</label>
        ...
        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="sr">star rating</label>
            <input type="number" name="sr" min="0" step="0.01" value="{{ old('sr', $map->sr ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="length">length (seconds)</label>
        ...
        <div class="input-container input-settings flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="cs">cs</label>
            <input type="number" name="cs" min="0" max="10" step="0.1" value="{{ old('cs', $map->cs ?? '') }}">

            <label class="button p-10 bold flex flex-f-center" for="hp">hp</label>
            <input type="number" name="hp" min="0" max="10" step="0.1" value="{{ old('hp', $map->hp ?? '') }}">

            <label class="button p-10 bold flex flex-f-center" for="ar">ar</label>
            <input type="number" name="ar" min="0" max="10" step="0.1" value="{{ old('ar', $map->ar ?? '') }}">

            <label class="button p-10 bold flex flex-f-center" for="od">od</label>
            <input type="number" name="od" min="0" max="10" step="0.1" value="{{ old('od', $map->od ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="setId">set id</label>
            <input type="number" name="setId" min="0" value="{{ old('setId', $map->setId ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="mapId">map id</label>
            <input type="number" name="mapId" min="0" value="{{ old('mapId', $map->mapId ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="submitDate">submit date</label>
            <input type="datetime-local" name="submitDate" step="1" value="{{ old('submitDate', $map->submitDate ?? '') }}">
        </div>

        <div class="input-container flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="lastUpdated">last updated</label>
        ...
        <div class="input-container input-tags flex flex-f-center g-10">
            <label class="button p-10 bold flex flex-f-center" for="tags">tags</label>
