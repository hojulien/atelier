        ...
        <div class="map-card flex p-20"
            ...
            <div class="map-right-container g-20 flex flex-col">
                ...
                <div class="map-settings flex">
                    ...
                    <div class="map-settings-card flex flex-col flex-f-center p-10 small-card" id="hp">
                        <span>HP</span>
                        <span>{{ trim_float($map->hp) }}</span>
                    </div>
                    <div class="map-settings-card flex flex-col flex-f-center p-10 small-card" id="ar">
                        <span>AR</span>
                        <span>{{ trim_float($map->ar) }}</span>
                    </div>
                    <div class="map-settings-card flex flex-col flex-f-center p-10 small-card" id="od">
                        <span>OD</span>
                        <span>{{ trim_float($map->od) }}</span>
                    </div>
                    <div class="map-settings-card flex flex-col flex-f-center p-10 medium-card" id="sr">
                        <span>SR</span>
                        <span>{{ number_format(ceil($map->sr * 100) / 100, 2) }}★</span>
                    </div>
                    <div class="map-settings-card flex flex-col flex-f-center p-10 large-card" id="length">
                        <span>LENGTH</span>
                        <span>{{ gmdate('i:s', $map->length) }}</span>
                    </div>
                    <div class="map-settings-card flex flex-col flex-f-center p-10 medium-card" id="favorite">
