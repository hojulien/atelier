@if ($paginator->hasPages())
    <nav class="flex g-10">
        <ul class="pagination flex flex-f-center g-10">
            ...
            <form method="GET" action="{{ route('playlist.index') }}">
                ...
                <select name="playlists_per_page" class="per_page" id="playlists_per_page" onchange="this.form.submit()">
                    <option value="10" @if(request('playlists_per_page') == 10) selected @endif>10</option>
                    <option value="25" @if(request('playlists_per_page') == 25) selected @endif>25</option>
                    <option value="50" @if(request('playlists_per_page') == 50) selected @endif>50</option>
                </select>
