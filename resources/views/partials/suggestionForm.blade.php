        ...
        <div class="error hidden" id="error_suggestion_description"></div>
        ...
        <div class="input-container flex stretch g-10">
            ...
            <div class="flex flex-col flex-f-center w-full max-w-600">
                <input type="file" name="media_file" id="media-field">
                    ...
                    <img class="w-full round-10" src="{{ asset('storage/images/suggestions/' . $suggestion->media) }}" alt="current suggestion media">
                    @endif
            </div>
        </div>
        <div class="error hidden" id="error_music_field"></div>
